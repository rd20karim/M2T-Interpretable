...
class seq2seq(nn.Module):
    ...
    def forward(self, x, y, teacher_force_ratio=0,src_lens=None):
        ...
        #  ------------ Frame wise pos features : R # shape  : (T,N,V,C)
        ...
        if self.beam_size==1:
            ...
            for j in range(trg_len-1):
                ...
                _,(bot_ht_1,bot_mt_1) = self.dec.bottom_lstm(self.dec(y_s),(bot_ht_1,bot_mt_1))
                ...
                # ------ Word Probability distribution pt = softmax(Up.tanh(Wp[ht; ̄ct,y_t-1] + bp) +d)
